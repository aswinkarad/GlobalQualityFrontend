                    ...
                    <v-container fluid>
                        <v-row dense>
                            <v-col cols="12" :sm="isMobile ? 12 : 6">
                                <v-text-field color="#7b1fa2" label="User Name" density="compact" v-model="item.username"
                            ...
                            <v-col cols="12" :sm="isMobile ? 12 : 6">
                                <v-text-field color="#7b1fa2" label="Email" density="compact" v-model="item.email"
                            ...
                            <v-col cols="12" :sm="isMobile ? 12 : 6">
                                <v-text-field color="#7b1fa2" label="Mobile" density="compact" v-model="item.mobile"
...
export default {
    ...
    watch: {
        item: {
            handler(newVal) {
                console.log("Updated item:", newVal);
            },
            deep: true,
            immediate: true
        }
